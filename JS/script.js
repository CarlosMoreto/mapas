	...
	try {
		(async function initializeMap() {
			try {
				...
				document.getElementById('test').innerHTML = 'Error loading the GeoJSON file: ' + error.message;
		...
		document.getElementById('test').innerHTML = 'Error initializing map: ' + error;
	}
});